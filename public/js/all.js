(function($) {
  ...
  function init_classic_menu_resize() {
    ...
    if ($(window).width() <= 1130) {
      $('.main-nav-main').addClass('mobile-on');
      $('.main-nav-sub').removeClass('mobile-on');
    } else if ($(window).width() > 1130) {
      $('.main-nav-main').removeClass('mobile-on');
      $('.main-nav-sub').removeClass('mobile-on');
  ...
  function init_classic_menu() {
    ...
    $('.js-sub-transparent').css('display', 'none');
    $(window).scroll(function() {
      var scrollBottom =
        $(document).height() - $(window).height() - $(window).scrollTop();
      if ($(window).scrollTop() > 10) {
        $('.js-transparent').removeClass('transparent');
        $('.js-sub-transparent').css('display', 'block');
        if ($(window).width() > 1024 && scrollBottom > 100) {
          $('.float-card').css('opacity', '1');
        } else {
          $('.float-card').css('opacity', '0');
        }
      ...
      if ($(window).width() > 768) {
        ...
        $('.sidebar-widget-coll').css('position', 'relative');
        $('.sidebar-widget-coll').css('margin-top', '0px');
        $('#post-1').css('margin-top', '-100px');
